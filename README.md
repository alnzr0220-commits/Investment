...
### 1. لوحة تحكم الإدمن 👨‍💼
- تسجيل دخول من نفس صفحة التسجيل العادية
- بيانات إدمن مخصصة: `مدير النظام الرئيسي` / `admin123`
- تمييز بصري فوري عند إدخال بيانات الإدمن
...
### للإدمن:
1. الذهاب إلى صفحة التسجيل العادية
2. إدخال بيانات الإدمن المخصصة:
   - **الاسم**: `مدير النظام الرئيسي`
   - **كلمة المرور**: `admin123`
3. النظام سيتعرف تلقائياً على الإدمن ويوجهه لصفحة الإدمن
4. مشاهدة جميع المشتركين وعرض تفاصيل أي مشترك
