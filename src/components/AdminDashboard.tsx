...
import { Database, LogOut, Search, User, Eye } from 'lucide-react';
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {loading ? (
                        ...
                        filteredSubscribers.map((subscriber) => (
                          <tr key={subscriber.subscriberNumber} className="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-900">#{subscriber.subscriberNumber}</div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                {subscriber.sharesCount} سهم
                              </span>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                              {subscriber.realPortfolioValue.toLocaleString()} SAR
                            </td>
